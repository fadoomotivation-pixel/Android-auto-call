...
type Answer = { answer: string; confidence: "high" | "medium" | "low" | "none"; sources: Source[] };
...
/**
 * RAG v6 — the glass box. Ask the company's AI anything and watch it show its
 * working: the answer, an honest confidence badge, and the exact source facts it
 * used with match scores. Nothing hidden — the demo-day "wow".
 */
  ...
  return (
    <div className="card" style={{ marginTop: 4, marginBottom: 20, background: "rgba(255,255,255,0.015)", border: "1px solid var(--border)", borderRadius: 16, padding: 20 }}>
      ...
      <p className="subtitle" style={{ marginTop: 2 }}>
        See exactly what it knows — the answer, how sure it is, and the source facts it used.
      </p>
